...
// const API_URL = 'http://localhost:3000/api/news'; // Proxy URL to your backend server
...
//       // Filter out articles without images and limit to top 20
...
//         <button 
//           onClick={fetchNews} 
//           className='bg-purple-500 hover:bg-purple-400 px-6 py-2 text-white rounded-md drop-shadow-lg'>
...
//         <button 
//           className='bg-black px-6 py-1 text-white rounded-md' 
